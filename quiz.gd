...
func _ready():
	...
	# Connecter les signaux du bouton Retry et du Timer
	...
	timer.start()
	next_button.visible = false  # Cacher le bouton next car on passe automatiquement
...
func _on_retry_pressed():
	...
	next_button.visible = false  # On garde le bouton next caché
